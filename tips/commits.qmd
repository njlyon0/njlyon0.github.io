...
| `dev` | {{< fa compass >}} | **<span style="color:#FF9B00">This is my un-official addition</span>!** Changes to files that are not a 'real' part of the build (e.g., exploratory changes) but ones where I may want to "roll back" future changes to this point |
...
| `style` | {{< fa brush >}} | Changes that do not affect the meaning of the code (e.g., white space, formatting, etc. |
