...
This package contains all of the standalone functions written by the NCEAS Scientific Computing Support Team that don't cleanly fit in other repositories. This is similar in rationale to the `supportR` package but in this case, many of the functions were written by others and I have simply maintained them and improved them where the opportunity arises.
