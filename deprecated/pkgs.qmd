...
## [`ltertools`](https://github.com/lter/ltertools#readme)

_Hex logo in development!_

### Tools Developed by the Long Term Ecological Research Community

This package contains functions developed by members of the LTER community. This package is meant to help centralize useful tools that individuals develop but that may be broadly useful. There are extensive contributing guidelines to ensure that everyone is given appropriate intellectual credit for lending their insight. More information on the Network can be found [here](https://lternet.edu/). **A version of this package is available on CRAN [here](https://cran.rstudio.com/web/packages/ltertools/index.html).**
